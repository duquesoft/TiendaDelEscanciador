      ...
      <section className="bg-white/80 rounded-xl shadow-lg border border-green-200 max-w-2xl w-full p-8 backdrop-blur-md">
        ...
        <div className="space-y-6 text-gray-800 text-base md:text-lg">
          ...
          <div>
            ...
            <p className="mb-4">No compartimos tu información personal con terceros sin tu consentimiento, excepto en los siguientes casos:</p>
            <ul className="list-disc list-inside space-y-2">
          ...
          <div>
            ...
            <p className="mb-2">Si tienes preguntas sobre esta Política de Privacidad o tus datos personales, puedes contactarnos en:</p>
            <p className="mb-2"><strong>Correo:</strong> contacto@tiendadelescanciador.com</p>
          </div>

          <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. Cambios en esta Política</h2>
            <p>Podemos actualizar esta Política de Privacidad en cualquier momento. Los cambios serán efectivos inmediatamente después de su publicación en el sitio web.</p>
          </div>
